...
#include "UnityCG.cginc"
            ...
            float noise(half2 uv)
            {
                ...
                float a = hash12(i);
                float b = hash12(i + half2(1.0, 0.0));
                float c = hash12(i + half2(0.0, 1.0));
                float d = hash12(i + half2(1.0, 1.0));
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                ...
                float vignette_amount = vignette(i.uv, u_vignette_size, u_vignette_smoothness, u_vignette_edge_round);
                ...
                col = lerp(col, fixed(noise(i.uv * u_noise_size)), u_noise_amount);

                return col * vignette_amount;
            }
